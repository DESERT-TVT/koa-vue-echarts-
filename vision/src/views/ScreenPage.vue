<template>
  <div class="screen-container" :style="containerStyle">
    <header class="screen-header">
      ...
      <span class="title" :style="Ititle">电商平台实时监控系统</span>
...
<script>
import Hot from '@/components/HotContent.vue'
import Map from '@/components/MapContent.vue'
import Rank from '@/components/RankContent.vue'
import Seller from '@/components/SellerContent.vue'
import Stock from '@/components/StockContent.vue'
import Trend from '@/components/TrendContent.vue'
